...
cat > /usr/include/ruby-3.0.0/ruby/backward/rubyio.h <<EOF
#if   defined __GNUC__
...
# We need newt < 1.0.0 because of `get_current_as_string` and others.
# See  https://www.rubydoc.info/gems/newt#label-Migrating+from+0.9+to+1.0
